...
class AquisicaoGerDeSinais(QMainWindow):
    def __init__(self, parent=None):
        ...
        #FALTA IMPLEMENTAR O BOTÃO DE PAUSAR
        ...
        #FALTA IMPLEMENTAR O BOTÃO DE ZERAR
        ...
        self.buttonGerador = QPushButton(parent=self.layoutWidget)
        self.buttonGerador.setFont(font)
        self.buttonGerador.setText("Cfg.Gerad")
        self.buttonGerador.clicked.connect(self.openConfigGerador)
        self.horizontalLayout.addWidget(self.buttonGerador)
    ...
    def openConfigGerador(self):
        self.configGerador = ConfigGerador()
        self.configGerador.showWindow()